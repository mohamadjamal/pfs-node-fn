...
gcloud config set project pfs-demo-project
```
...
```sh
gcloud projects add-iam-policy-binding pfs-demo-project --member serviceAccount:pfs-demo-image@pfs-demo-project.iam.gserviceaccount.com --role roles/storage.admin
```
...
```sh
pfs namespace init pfs-demo-namespace -m C:\Work\tao-workspace\pfs-downloads\pfs-distro-thin\manifest.yaml --gcr C:\Work\tao-workspace\gcr-storage-admin.json
